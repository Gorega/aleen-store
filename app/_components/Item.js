...
export default function Item({content,tableShape}){
    ...
    const {addToCartHandler,
            ...
            checkIsFavourite,
            checkIsInCart,
            addToCompareProductsHandler} = useContext(ContextApi);
    ...
    return <div className={`${styles.item} ${tableShape ? styles.tableView : ""}`}>
            ...
            <div className={styles.control}>
                <div className={`${styles.favourite} ${checkIsFavourite(content._id) ? styles.active : ""}`} onClick={()=> addToFavouriteHandler(content)}>
